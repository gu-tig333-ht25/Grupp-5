        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: Text(m.note, style: const TextStyle(color: Colors.white, fontSize: 16)),
            ),
          ],
        ),
      ),
                ...
                child: ClipRRect(
                  ...
                  child: FlutterMap(
                    ...
                    children: [
                      ...
                      MarkerLayer(
                        markers: _markers.map<Marker>((m) {
                          return Marker(
                            width: 48,
                            height: 48,
                            point: m.position,
                            // VIKTIGT: nyare flutter_map använder 'child:' (inte 'builder:')
          ...
          Row(
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () => Navigator.pop<_NewMoodResult>(
                  context,
